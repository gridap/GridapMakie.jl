...
function Makie.convert_arguments(::Union{Type{Makie.Lines},Type{Makie.ScatterLines},Type{Makie.Scatter}}, trian::Union{Triangulation{0,1},Triangulation{1,1}}, uh::Any)
    data = to_point1D(trian, uh)
    y = data[2]
    x = data[1]
    (x,y)
end
